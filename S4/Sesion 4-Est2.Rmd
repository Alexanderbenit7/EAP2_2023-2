...
El comando **parse_number** nos permite extraer valores númericos de un string.
...
Por ejemplo, queremos ordenar la base en orden ascendente por monto de desembolso y por monto por tasa:
